...
@Component({
  selector: 'app-latestcode',
  templateUrl: './latestcode.component.html',
  styleUrls: ['./latestcode.component.scss']
})
export class LatestcodeComponent implements OnChanges, OnDestroy {
  ...
  constructor(private cookieService: CookieService, private _favorite: FavoriteService, private _project: ProjectService, private _notification: NotificationService) { }
