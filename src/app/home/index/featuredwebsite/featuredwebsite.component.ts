...
@Component({
  selector: 'app-featuredwebsite',
  templateUrl: './featuredwebsite.component.html',
  styleUrls: ['./featuredwebsite.component.scss']
})
export class FeaturedwebsiteComponent implements OnChanges, OnDestroy {
  ...
  ngOnChanges(changes: SimpleChanges): void {
    if (changes['project_list'] && this.project_list?.length) {
      ...
      const filtered = this.project_list.filter(
        project => project.typeName === 'Website'
      );
