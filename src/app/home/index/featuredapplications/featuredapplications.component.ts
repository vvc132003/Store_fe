...
@Component({
  ...
  styleUrls: ['./featuredapplications.component.scss']
})
export class FeaturedapplicationsComponent implements OnChanges, OnDestroy {
  ...
  ngOnChanges(changes: SimpleChanges): void {
    if (changes['project_list'] && this.project_list?.length) {
      ...
      const filtered = this.project_list.filter(
        project => project.typeName === 'Ứng dụng'
      );
